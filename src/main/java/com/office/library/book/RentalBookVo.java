...
public class RentalBookVo {
	...
	public int getRev_b_no_count() {
		return rev_b_no_count;
	}
	public void setRev_b_no_count(int rev_b_no_count) {
		this.rev_b_no_count = rev_b_no_count;
	}
	public int getLike_b_no_count() {
		return like_b_no_count;
	}
	public void setLike_b_no_count(int like_b_no_count) {
		this.like_b_no_count = like_b_no_count;
	}
